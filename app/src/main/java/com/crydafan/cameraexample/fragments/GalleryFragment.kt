...
import com.crydafan.cameraexample.databinding.FragmentGalleryBinding
import com.crydafan.cameraexample.utils.MediaStoreFile
import com.crydafan.cameraexample.utils.MediaStoreUtils
import com.crydafan.cameraexample.utils.padWithDisplayCutout
import com.crydafan.cameraexample.utils.showImmersive
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentGalleryBinding.deleteButton.setOnClickListener {
            ...
            mediaList.getOrNull(fragmentGalleryBinding.photoViewPager.currentItem)
                ?.let { mediaStoreFile ->
                    AlertDialog.Builder(view.context, R.style.Theme_Material_Dialog)
                        .setTitle(getString(R.string.delete_title))
                        .setMessage(getString(R.string.delete_dialog))
                        .setIcon(android.R.drawable.ic_dialog_alert)
                        .setPositiveButton(android.R.string.ok) { _, _ ->

                            // Delete current photo from MediaStore
                            requireContext().contentResolver.delete(mediaStoreFile.uri, null, null)
